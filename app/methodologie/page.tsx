    ...
    <main>
      ...
      <section className="panel">
        ...
        <ul className="prose">
          ...
          <li><strong>Plusieurs régimes</strong> : haussier, baissier et range — un backtest qui ne couvre qu&apos;un bull market surévalue.</li>
          <li><strong>Frais + slippage</strong> appliqués à chaque trade.</li>
          <li><strong>Significativité</strong> : un win rate élevé sur peu de trades = bruit ; on regarde le <em>nombre</em> de trades, pas qu&apos;un %.</li>
        </ul>
        <p className="prose"><strong>Limite du simulé</strong> : sur prix on applique frais + slippage, mais la réalité on-chain ajoute gas, profondeur de liquidité, MEV/frontrunning et transactions échouées. Le simulé est donc un <em>plafond optimiste</em> — le vrai juge, c&apos;est le <Link href="/paper">paper trading forward</Link>.</p>
      ...
      <section className="panel">
        ...
        <ul className="prose">
          ...
          <li><strong>Sharpe / Sortino</strong> — rendement risque-ajusté (le Sharpe suppose des rendements ~normaux ; en crypto à queues épaisses, le <strong>Sortino</strong> est plus fiable).</li>
      ...
      <section className="panel">
        ...
        <p className="prose">Biais à garder en tête : <strong>survivance</strong> (on ne voit que les bots publics encore en ligne) et <strong>sélection</strong> (seules les stratégies sur prix sont backtestées — MEV/sniping, parfois les plus rentables, n&apos;ont aucune perf affichée).</p>
